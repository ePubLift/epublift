...
## [web-v1.9.1] - 2026-06-26

### Fixed
- Kobo `.kepub` downloads are now named `<name>_v3.3.kepub.epub` (was
  `<name>.kepub.epub`) — shared with the CLI fix above.
- **The "WebP images in .kepub" toggle now implies Kobo `.kepub` output.**
